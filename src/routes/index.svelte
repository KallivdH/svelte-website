<div id="hero" class="min-h-screen-5/6 flex items-center font-mono py-10">
	<div class="grid md:grid-cols-2 grid-cols-1 gap-1">
		...
		<div class="mt-5 md:mt-0" id="hero-img">
			<img
				class="float-left md:float-right"
				src="kalli.png?nf_resize=fit&w=383&h=404"
				alt="Kalli van den Heuvel"
				width="383px"
				height="404px"
			/>
		</div>
...
<div id="projects" class="text-white font-mono py-10">
	<div
		class="w-full bg-blue-700 md:p-5 lg:p-10 rounded-3xl flex flex-wrap justify-center md:flex-nowrap mb-10"
	>
		<div class="flex-shrink-0 p-6 sm:p-10">
			<img
				class="object-contain"
				src="website-stack.png?nf_resize=fit&w=250&h=226"
				alt="Website stack"
				width="250px"
				height="250px"
			/>
	...
	<div
		class="w-full bg-red-700 md:p-5 lg:p-10 rounded-3xl flex justify-center flex-wrap md:flex-nowrap"
	>
		<div class="p-6 sm:p-10">
		...
		<div class="p-6 sm:p-10 flex-shrink-0">
			<img
				src="spring-boot.png?nf_resize=fit&w=200&h=180"
				class="float-right object-contain"
				alt="Website stack"
				width="200px"
				height="200px"
			/>
